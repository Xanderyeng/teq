        ...
        >
          ...
          >
            ...
            <div className='relative mt-10 z-0 p-[1px] rounded-21 bg-gradient-to-b from-[#DE89FC] via-[#9AC2FE] to-[#88D2FF]'>
              ...
              <button className='relative px-14 py-4 text-primary capitalize text-[1.6rem] bg-secondary rounded-21 hover:bg-gradient-to-b from-[#DE89FC] via-[#9AC2FE] to-[#88D2FF] hover:text-black'>
                See more
              </button>
            </div>
          </div>
